...
import com.patriciameta.ajr_pegawai.adapters.Top5CustAdapter;
...
public class Top5CustActivity extends AppCompatActivity {
    ...
    private Top5CustAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_top5_cust);

        //  Ubah Title pada App Bar Aplikasi
        setTitle("Laporan Top 5 Customer");
        userPreferences = new UserPreferences(Top5CustActivity.this);
        ...
        RecyclerView rvTransaksi = findViewById(R.id.rv_top5C);
        adapter = new Top5CustAdapter(new ArrayList<>(), this);
        rvTransaksi.setLayoutManager(new LinearLayoutManager(Top5CustActivity.this,
    ...
    private void getAllTransaksi(){
        Call<TransaksiResponse> call = apiService.getTop5Cust();
        ...
        call.enqueue(new Callback<TransaksiResponse>() {
            ...
            public void onResponse(Call<TransaksiResponse> call, Response<TransaksiResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        Toast.makeText(Top5CustActivity.this,
            ...
            public void onFailure(Call<TransaksiResponse> call, Throwable t) {
                Toast.makeText(Top5CustActivity.this, "Network error",
                        Toast.LENGTH_SHORT).show();
                srTransaksi.setRefreshing(false);
            }
        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId() == R.id.menu_home) {
            finishAndRemoveTask();
            startActivity(new Intent(Top5CustActivity.this, MainActivity.class));
        } else if (item.getItemId() == R.id.menu_mobil) {
//            Top5CustActivity.activity.finish();
            finishAndRemoveTask();
            startActivity(new Intent(Top5CustActivity.this, BulanActivity.class));
        } else if (item.getItemId() == R.id.menu_cust) {
//            Top5CustActivity.activity.finish();
            finishAndRemoveTask();
            startActivity(new Intent(Top5CustActivity.this, BulanActivity2.class));
        } else if (item.getItemId() == R.id.menu_topDriver) {
            finishAndRemoveTask();
            startActivity(new Intent(Top5CustActivity.this, BulanActivity3.class));
...
//            Top5CustActivity.activity.finish();
    ...
    private void checkLogin(){
        if(!userPreferences.checkLogin()){
            startActivity(new Intent(Top5CustActivity.this, LoginActivity.class));
            finish();
        }
    }
    ...
    private void cetakPdf() throws FileNotFoundException, DocumentException {
        ...
        PdfPCell h2 = new PdfPCell(new Phrase("Jumlah Peminjaman"));
