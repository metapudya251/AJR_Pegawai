...
import com.patriciameta.ajr_pegawai.adapters.Top5DriverAdapter;
...
public class Top5DriverActivity extends AppCompatActivity {
    ...
    private Top5DriverAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_top5_driver);

        //  Ubah Title pada App Bar Aplikasi
        setTitle("Laporan Top 5 Driver");
        userPreferences = new UserPreferences(Top5DriverActivity.this);
        ...
        RecyclerView rvTransaksi = findViewById(R.id.rv_top5D);
        adapter = new Top5DriverAdapter(new ArrayList<>(), this);
        rvTransaksi.setLayoutManager(new LinearLayoutManager(Top5DriverActivity.this,
    ...
    private void getAllTransaksi(){
        Call<TransaksiResponse> call = apiService.getTop5Driver();
        ...
        call.enqueue(new Callback<TransaksiResponse>() {
            ...
            public void onResponse(Call<TransaksiResponse> call, Response<TransaksiResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        Toast.makeText(Top5DriverActivity.this,
            ...
            public void onFailure(Call<TransaksiResponse> call, Throwable t) {
                Toast.makeText(Top5DriverActivity.this, "Network error",
                        Toast.LENGTH_SHORT).show();
                srTransaksi.setRefreshing(false);
            }
        });
...
//            Top5DriverActivity.activity.finish();
            finishAndRemoveTask();
            startActivity(new Intent(Top5DriverActivity.this, MainActivity.class));
        } else if (item.getItemId() == R.id.menu_mobil) {
//            Top5DriverActivity.activity.finish();
            finishAndRemoveTask();
            startActivity(new Intent(Top5DriverActivity.this, BulanActivity.class));
        } else if (item.getItemId() == R.id.menu_cust) {
//            Top5DriverActivity.activity.finish();
            finishAndRemoveTask();
            startActivity(new Intent(Top5DriverActivity.this, BulanActivity2.class));
        } else if (item.getItemId() == R.id.menu_topDriver) {
            //
        } else if (item.getItemId() == R.id.menu_topCust) {
//            Top5DriverActivity.activity.finish();
            finishAndRemoveTask();
            startActivity(new Intent(Top5DriverActivity.this, BulanActivity4.class));
    ...
    private void checkLogin(){
        if(!userPreferences.checkLogin()){
            startActivity(new Intent(Top5DriverActivity.this, LoginActivity.class));
            finish();
        }
    }
    ...
    private void cetakPdf() throws FileNotFoundException, DocumentException {
        ...
        // Setup Column
        PdfPCell h1 = new PdfPCell(new Phrase("No Driver"));
