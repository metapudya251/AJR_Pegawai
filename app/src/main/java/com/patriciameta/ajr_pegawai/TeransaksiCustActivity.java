...
import com.patriciameta.ajr_pegawai.adapters.LapCustAdapter;
...
public class TeransaksiCustActivity extends AppCompatActivity {
    ...
    private LapCustAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teransaksi_cust);

        //  Ubah Title pada App Bar Aplikasi
        setTitle("Laporan Pendapatan Customner");
        userPreferences = new UserPreferences(TeransaksiCustActivity.this);
        ...
        RecyclerView rvTransaksi = findViewById(R.id.rv_transaksiCust);
        adapter = new LapCustAdapter(new ArrayList<>(), this);
        rvTransaksi.setLayoutManager(new LinearLayoutManager(TeransaksiCustActivity.this,
    ...
    private void getAllTransaksi(){
        Call<TransaksiResponse> call = apiService.getIncomeCust();
        ...
        call.enqueue(new Callback<TransaksiResponse>() {
            ...
            public void onResponse(Call<TransaksiResponse> call, Response<TransaksiResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        Toast.makeText(TeransaksiCustActivity.this,
            ...
            public void onFailure(Call<TransaksiResponse> call, Throwable t) {
                Toast.makeText(TeransaksiCustActivity.this, "Network error",
                        Toast.LENGTH_SHORT).show();
                srTransaksi.setRefreshing(false);
            }
        });
...
//            TeransaksiCustActivity.activity.finish();
            finishAndRemoveTask();
            startActivity(new Intent(TeransaksiCustActivity.this, MainActivity.class));
        } else if (item.getItemId() == R.id.menu_mobil) {
//            TeransaksiCustActivity.activity.finish();
            finishAndRemoveTask();
            startActivity(new Intent(TeransaksiCustActivity.this, BulanActivity.class));
        } else if (item.getItemId() == R.id.menu_cust) {
            //
        } else if (item.getItemId() == R.id.menu_topDriver) {
            //            TeransaksiCustActivity.activity.finish();
            finishAndRemoveTask();
            startActivity(new Intent(TeransaksiCustActivity.this, BulanActivity3.class));
        } else if (item.getItemId() == R.id.menu_topCust) {
//            TeransaksiCustActivity.activity.finish();
            finishAndRemoveTask();
            startActivity(new Intent(TeransaksiCustActivity.this,BulanActivity4.class));
    ...
    private void checkLogin(){
        if(!userPreferences.checkLogin()){
            startActivity(new Intent(TeransaksiCustActivity.this, LoginActivity.class));
            finish();
        }
    }
    ...
    private void cetakPdf() throws FileNotFoundException, DocumentException {
        ...
        // bagian header
        Paragraph judul = new Paragraph("Laporan Pendapatan dari Customer \n\n",
        ...
        PdfPCell h4 = new PdfPCell(new Phrase("Total Transaksi"));
        h4.setHorizontalAlignment(Element.ALIGN_CENTER);
        h4.setPaddingBottom(5);
        PdfPCell h5 = new PdfPCell(new Phrase("Jumlah Pendapatan"));
        ...
        for (Transaksi P : listTransaksi) {
            ...
            tableData.addCell(P.getNama_cust());
